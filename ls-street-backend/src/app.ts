...
import { adminFavoriteRoutes } from "./modules/admin-favorites/admin-favorite.routes";
...
import {
  registerProductImageSchemas,
} from "./docs/schemas/product-image.schema";
import {
  registerErrorSchemas,
} from "./docs/schemas/error.schema";
